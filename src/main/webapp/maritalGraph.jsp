...
<header>
    <div class="container">
        <h1 style="text-align: center;"><span style="float: left;">Patient Data App</span>Marital Distribution Graph<span style="float: right;">Jash Shah</span></h1>
...
<div style="height: 750px; width: 750px; margin: auto;">
    <canvas id="maritalGraph"></canvas>
    <script type="text/javascript">
        const ctx = document.getElementById("maritalGraph");

        const data = {
            labels: <%=request.getAttribute("maritalStatuses")%>,
            datasets: [{
                data: <%=request.getAttribute("count")%>,
            }],
        };
