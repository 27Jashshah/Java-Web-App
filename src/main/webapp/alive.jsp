...
<header>
    <div class="container">
        <h1 style="text-align: center;"><span style="float: left;">Patient Data App</span>Alive Patients<span style="float: right;">Jash Shah</span></h1>
...
<div>
    <%
        String aliveNumber = (String) request.getAttribute("aliveNumber");
    %>
    <h4> Number of Patients Alive: <%= aliveNumber %></h4>
</div>
