...
<header>
    <div class="container">
        <h1 style="text-align: center;"><span style="float: left;">Patient Data App</span>Gender Distribution Graph<span style="float: right;">Jash Shah</span></h1>
...
<div style="height: 750px; width: 750px; margin: auto;">
    ...
    <script type="text/javascript">
        const ctx = document.getElementById("genderGraph");

        const data = {
            labels: <%=request.getAttribute("genders")%>,
            datasets: [{
