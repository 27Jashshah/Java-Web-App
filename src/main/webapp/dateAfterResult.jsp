...
<header>
    <div class="container">
        <h1 style="text-align: center;"><span style="float: left;">Patient Data App</span>After Date Filter<span style="float: right;">Jash Shah</span></h1>
...
<div class="main">
    <form method="POST" action="/runDateAfter.html">
...
<div style="display: flex">
    ...
    <h4>No. of Patients Born After: <%=count%></h4>
</div>
    <%
