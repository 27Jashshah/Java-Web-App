...
<div>
    <form method="POST" action="/runYoungest.html">
        <input type="text" name="youngestSearchString" placeholder="Enter number here" style="width: 250px"/>
...
<div>
    <%
        String youngestSearch = (String) request.getAttribute("youngestSearch");
        String rowCount = (String) request.getAttribute("rowCount");
    %>
    <h4> Entered number: <%= youngestSearch %></h4>
    <%
...
<%
    if(Integer.parseInt(youngestSearch) <= (Integer.parseInt(rowCount) - deadNum)){
        List<String> patients = (List<String>) request.getAttribute("patientNames");
        List<String> ids = (List<String>) request.getAttribute("ids");
        List<String> numbering = (List<String>) request.getAttribute("youngestNums");
%>
<div style=" margin-top: 20px; display: flex; justify-content: center; align-items: center;">
    <table style="text-align: left; position: relative;">
        ...
        <%} else if (Integer.parseInt(youngestSearch) > (Integer.parseInt(rowCount))){%>
